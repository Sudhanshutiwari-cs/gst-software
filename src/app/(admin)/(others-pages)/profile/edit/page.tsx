          ...
          <div className={`${headerClass} flex justify-between items-center`}>
            <div>
              ...
              <p className={subtitleClass}>
                {vendor ? "Update your vendor profile information" : "Create a new vendor profile"}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="flex justify-end pt-4">
                <button
                  ...
                  className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed font-semibold text-lg min-w-48"
                >
                  {loading ? (
