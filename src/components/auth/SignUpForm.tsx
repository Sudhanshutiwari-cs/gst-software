        ...
        <div>
          <div className="mb-5 sm:mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Enter your mobile number and verify with OTP to sign up!
            </p>
          </div>
          <div>
              ...
              <div className="space-y-5">
                  ...
                  <div className="flex gap-2">
                    ...
                    {!isOtpVerified && (
                      <button
                        ...
                        className="px-4 py-2 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600 whitespace-nowrap"
                      >
                ...
                <div>
                  <button 
                    ...
                    disabled={!isOtpVerified || !isChecked || isLoading}
                    className={`flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg shadow-theme-xs ${
                      isOtpVerified && isChecked && !isLoading
                        ? "bg-brand-500 hover:bg-brand-600" 
                        : "bg-gray-400 cursor-not-allowed"
                    }`}
                  >
                    {isLoading ? "Signing Up..." : 
                     isOtpVerified && isChecked ? "Sign Up" : "Complete Verification"}
                  </button>
                </div>
              </div>
            </form>
