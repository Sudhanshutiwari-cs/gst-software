...
export function InvoicePreview({ invoice, template, zoom, onZoomChange }: InvoicePreviewProps) {
  ...
  return (
    <div className="flex-1 overflow-auto p-6">
      ...
      <div 
        className="bg-white p-8 shadow-lg mx-auto max-w-4xl"
      ...
      >
        ...
        {/* Add other template variants here */}
        {template === 'classic' && (
